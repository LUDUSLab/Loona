...
public abstract class JellySprite : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (Application.isPlaying)
        {
            ...
            //<!-- Modified By JMG
            //m_ReferencePointParent.gameObject.AddComponent<ScaleWithPlayer>();
            // Modified By JMG -->
            m_ReferencePointParent.gameObject.tag = "ReferencePoints";
        ...
        if (Application.isPlaying)
        {
            ...
            for (int attachPointIndex = 0; attachPointIndex < numAttachPoints; attachPointIndex++)
            {
                ...
                if (m_IsAttachPointJellySprite[attachPointIndex])
                {
                    ...
                    attachedJellySprite.CentralPoint.transform.localPosition = m_InitialAttachPointPositions[attachPointIndex] + totalOffset;
                }
                else
                {
